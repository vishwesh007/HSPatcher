...
if (file("baselineprofile").isDirectory) {
    include(":baselineprofile")
}

if (file("benchmark").isDirectory) {
    include(":benchmark")
}

if (file("benchmark2").isDirectory) {
    include(":benchmark2")
}

project(":hspatcher-legacy").projectDir = file("../..")
project(":hspatcher-legacy").buildFileName = "build.gradle"
