...
data class CodeEditorState(val initialContent: Content? = null) {
    ...
    var isLoadingContent by mutableStateOf(initialContent == null)
    var loadFailed by mutableStateOf<String?>(null)

    /** Plain-text snapshot used only for binary detection; not for editor display */
    var contentTextSnapshot: String? = null
