...
object Settings {
    ...
    var shown_walkthrough by CachedPreference("shown_walkthrough", false)
    ...
    var app_orientation_mode by CachedPreference("app_orientation_mode", AppOrientation.MODE_PORTRAIT)
