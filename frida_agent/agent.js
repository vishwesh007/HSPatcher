...
Java.performNow(function() {
    ...
    try {
        ...
        // SSL bypass is PERMANENT — always enabled, no file toggle
        {
            ...
            // v3.45: REMOVED attemptErrorMapperHook() — it called
            ...
            // v3.45: REMOVED hookCronetCallbacks() with enumerateLoadedClasses —
            ...
            // v3.45: REMOVED JSONObject.getString/optString hooks — they ran on
        ...
        // Root detection - hide known root paths (v3.45: O(1) Set lookup)
        try {
            var File = Java.use('java.io.File');
        ...
        function scheduleRuleReload() {
            setTimeout(function() {
                ...
                scheduleRuleReload();
            }, 120000); // v3.45: 120s instead of 5s to reduce GC pressure
        }
        loadBlockingRules();
        loadHostRules();
        loadFilterMode();
        ...
        // v3.45: _fdMap, _fdLoggedSend, _fdLoggedRecv REMOVED — no longer
        ...
        // v3.45: onEnter-only (no onLeave) saves ~5μs per call per Frida docs
        try {
        ...
        // v3.45: REMOVED send()/sendto()/recvfrom() hooks — monitoring-only,
        ...
        // v3.45: REMOVED write()/read()/close() hooks — they intercepted EVERY
        ...
        //  v3.45: SSL_read removed (hot during streaming, monitoring-only)
        ...
        function tryAttachSSL(libName) {
            ...
            // v3.45: REMOVED SSL_read hook — monitoring-only (response viewing).
